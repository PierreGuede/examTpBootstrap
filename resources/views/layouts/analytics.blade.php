...
<head>
    ...
    {{-- @@include("partials/title-meta.html", {"title": "Analytics"}) --}}
    @include("layouts.partials.title-meta", ["title"=>"Analytics"])
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    {{-- @@include("partials/page-title.html", {"pagetitle": "Dashboards", "title": "Analytics"}) --}}
                    @include("layouts.partials.page-title", ["pagetitle"=>"Dashboard", "title"=>"Analytics"])
                    <div class="row">
                        <div class="col-xxl-5">
                                            ...
                                            <div class="card-body p-0">
                                                <div class="alert alert-primary border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                                                    ...
                                                    <div class="flex-grow-1 text-truncate">
                                                        Votre plan Gratuit expire dans <b>17</b> jours.
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <a href="https://maxfence.online/#pricing" class="text-reset text-decoration-underline"><b>Upgrade</b></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-end">
                                                    <div class="col-sm-8">
                                                        <div class="p-3">
                                                            <p class="fs-16 lh-base">Passez du plan <span class="fw-semibold">Gratuit
                                                                    </span> au 'Plan Premium' <i class="mdi mdi-arrow-right"></i></p>
                                                            <div class="mt-3">
                                                                <a href="https://maxfence.online/#pricing" class="btn btn-primary">Mettre A Jour !</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        ...
                                                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0">
                                                            ...
                                                            </span> par rapport au mois précédent</p>
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Temps Entre Deux Attaques</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="fw-medium text-muted mb-0">Attaques Bloquées</p>
                        ...
                        <div class="col-xxl-7">
                            <div class="row h-100">
                                <div class="col-xl-6">
                                    <div class="card card-height-100">
                                        <div class="card-header align-items-center d-flex">
                                            <h4 class="card-title mb-0 flex-grow-1">Utilisateurs live par pays</h4>
                                            <div class="flex-shrink-0">
                                ...
                                <div class="col-xl-6">
                                    <div class="card card-height-100">
                                        <div class="card-header align-items-center d-flex">
                                            <h4 class="card-title mb-0 flex-grow-1">Sessions par pays</h4>
                                            <div>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-header border-0 align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Analyse Des Données</h4>
                                    <div>
                                        <button type="button" class="btn btn-soft-secondary btn-sm">
                                            ALL
                                        </button>
                                    ...
                                    <div class="row g-0 text-center">
                                        <div class="col-6 col-sm-4">
                                            <div class="p-3 border border-dashed border-start-0">
                                                ...
                                                <p class="text-muted mb-0">Moy. Détection</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-6 col-sm-4">
                                            <div class="p-3 border border-dashed border-start-0">
                                                ...
                                                <p class="text-muted mb-0">Moy. Prévention</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                        <div class="col-6 col-sm-4">
                                            <div class="p-3 border border-dashed border-start-0 border-end-0">
                                                ...
                                                <p class="text-muted mb-0">Moy. Temps de latence</p>
                                            </div>
                                        </div>
                                        <!--end col-->
                                    </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card card-height-100">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Taux de regression</h4>
                                    <div class="flex-shrink-0">
                                        <div class="dropdown card-header-dropdown">
                                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="fw-semibold text-uppercase fs-12">Trier par: </span><span class="text-muted">Semaine en cours<i class="mdi mdi-chevron-down ms-1"></i></span>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="#">Aujourd'hui</a>
                                                <a class="dropdown-item" href="#">Week-end dernier</a>
                                                <a class="dropdown-item" href="#">Mois dernier</a>
                                                <a class="dropdown-item" href="#">Année dernière</a>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- end card header -->
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card card-height-100">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Périphériques Vecteurs d'Attaque</h4>
                                    <div class="flex-shrink-0">
                                        <div class="dropdown card-header-dropdown">
                                            <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="table-responsive mt-3">
                                        <table class="table table-borderless table-sm table-centered align-middle table-nowrap mb-0">
                                            <tbody class="border-0">
                                                <tr>
                                                    <td>
                                                        <h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-primary me-2"></i>Desktop</h4>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-success me-2"></i>Mobile</h4>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <h4 class="text-truncate fs-14 fs-medium mb-0"><i class="ri-stop-fill align-middle fs-18 text-primary me-2"></i>Tablet</h4>
                                                    </td>
                                                    <td>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Les sites les plus attaqués</h4>
                                    <div class="flex-shrink-0">
                                        <button type="button" class="btn btn-soft-primary btn-sm">
                                            Exporter le Rapport
                                        </button>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-2 text-center">
                                        <a href="javascript:void(0);" class="text-muted text-decoration-underline">Tout afficher</a>
                                    </div>
                                    ...
                                    <div class="table-responsive table-card">
                                        <table class="table align-middle table-borderless table-centered table-nowrap mb-0">
                                            <thead class="text-muted table-light">
                                                <tr>
                                                    <th scope="col" style="width: 62;">Top Pages</th>
